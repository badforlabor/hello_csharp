...
namespace crazy_collects
{
    ...
    public class CrazyDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>, ISerializable, IDeserializationCallback
    {
        ...
        public CrazyDictionary() : this(0, null) { }

        public CrazyDictionary(int capacity) : this(capacity, null) { }

        public CrazyDictionary(IEqualityComparer<TKey> comparer) : this(0, comparer) { }

        public CrazyDictionary(int capacity, IEqualityComparer<TKey> comparer)
        {
            if (capacity < 0) ThrowHelper.ThrowArgumentOutOfRangeException(ExceptionArgument.capacity);
            if (capacity > 0) Initialize(capacity);
            this.comparer = comparer ?? EqualityComparer<TKey>.Default;

#if false && FEATURE_CORECLR
        ...
        public CrazyDictionary(IDictionary<TKey, TValue> dictionary) : this(dictionary, null) { }

        public CrazyDictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) :
        ...
        protected CrazyDictionary(SerializationInfo info, StreamingContext context)
        {
...
#if false && FEATURE_RANDOMIZED_STRING_HASHING
        ...
        public sealed class KeyCollection : ICollection<TKey>, ICollection, IReadOnlyCollection<TKey>
        {
            ...
            public KeyCollection(CrazyDictionary<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                {
                    ThrowHelper.ThrowArgumentNullException(ExceptionArgument.dictionary);
            ...
            public struct Enumerator : IEnumerator<TKey>, System.Collections.IEnumerator
            {
                ...
                internal Enumerator(CrazyDictionary<TKey, TValue> dictionary)
                {
                    this.dictionary = dictionary;
                    version = dictionary.version;
                    index = 0;
        ...
        public sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
        {
            ...
            public ValueCollection(CrazyDictionary<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                {
                    ThrowHelper.ThrowArgumentNullException(ExceptionArgument.dictionary);
